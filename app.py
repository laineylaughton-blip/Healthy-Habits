...
<body class="gradient-1">
    ...
    <script>
        ...
        function selectClassPresetColor(color,event){
...
function initClassColorPicker() {
   const gradientPicker = document.getElementById('classGradientPicker');
   const hexInput = document.getElementById('classColor');
   const colorPreview = document.getElementById('classColorPreview');
   ...
   gradientPicker.addEventListener('click', (e) => {
       ...
       const index = Math.floor(percent * colors.length);
